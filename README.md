...
* [warrant](https://github.com/warrant-dev/warrant) - An open source application authorization and access control service built for developers and product teams.
...
* [ergo](https://github.com/ergo-services/ergo) - an actor based Framework for creating event-driven architecture using technologies and design patterns of Erlang/OTP in Golang with Zero dependencies
...
* [dagu](https://github.com/dagu-labs/dagu) - Yet another cron alternative with a Web UI, but with much more capabilities. It aims to solve greater problems.
...
* [jwt-api](https://github.com/evgomes/jwt-api) - Example API that shows how to implement JSON Web Token authentication and authorization with ASP.NET 6, built from scratch. Related article: https://medium.com/@evandro.ggomes/json-web-token-authentication-with-asp-net-core-2-0-b074b0cfc870
...
* [zoom.js](https://github.com/nishanths/zoom.js) - Port of 'fat/zoom.js' with improvements and no dependencies.
