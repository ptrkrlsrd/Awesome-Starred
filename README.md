...
* [rest.nvim](https://github.com/NTBBloodbath/rest.nvim) - A fast Neovim http client written in Lua
...
* [nvim](https://github.com/catppuccin/nvim) - 🍨 Soothing pastel theme for NeoVim
...
* [designdeck](https://github.com/teivah/designdeck) - An Open-Source Collection of 160+ Flash Cards to Help you Succeding your System Design Interview and More 💯 
...
* [OpenCQRS](https://github.com/lucabriguglia/OpenCQRS) - .NET Standard framework to create simple and clean design. Advanced features for DDD, CQRS and Event Sourcing.
...
* [Library](https://github.com/FastEndpoints/Library) - A light-weight REST API development framework for ASP.Net 6 and newer.
...
* [novelWriter](https://github.com/vkbo/novelWriter) - novelWriter is an open source plain text editor designed for writing novels. It supports a minimal markdown-like syntax for formatting text. It is written with Python 3 (3.7+) and Qt 5 (5.3+) for cross-platform support.
...
* [navigator.lua](https://github.com/ray-x/navigator.lua) - Symbol analysis & navigation plugin for Neovim. Navigate codes like a breeze🎐.  Exploring LSP and 🌲Treesitter symbols a piece of 🍰. Take control like a boss 🦍.
...
* [griddd](https://github.com/shankariyerr/griddd) - A dead simple, customisable, flexbox-based griddd
...
* [zoom.js](https://github.com/nishanths/zoom.js) - Dependency-free  (no jQuery, no Bootstrap) fork of fat/zoom.js
